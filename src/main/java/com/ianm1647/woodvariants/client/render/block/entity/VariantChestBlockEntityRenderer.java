...
import com.ianm1647.woodvariants.client.render.VariantTexturedRenderLayers;
...
public class VariantChestBlockEntityRenderer<T extends BlockEntity> implements BlockEntityRenderer<T> {
    ...
    public VariantChestBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
    ...
    public void render(T entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers,
        ...
        WoodType woodType = ((VariantChestBlockEntity) entity).getWoodType();
        ...
        DoubleBlockProperties.PropertySource<? extends ChestBlockEntity> propertySource = bl
                ? abstractChestBlock.getBlockEntitySource(blockState, world, entity.getPos(), true)
        ...
        SpriteIdentifier spriteIdentifier = VariantTexturedRenderLayers.getTextureId(entity, chestType, this.christmas, woodType);
